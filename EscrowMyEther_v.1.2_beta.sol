    ...
    contract EscrowMyEther  {
        ...
        //Version: EscrowMyEther v1.2 Beta

        //Changelog

        //Retrieving escrow and seller history is now split in 2 functions.
        //Able to specify number of transaction history to retrieve per function call.
