    ...
    contract EscrowMyEther  {
        ...
        {    
            ...
            //uint nounce;            //Nounce of escrow contract            
        ...
        {
            require(ID < buyerDatabase[msg.sender].length && buyerDatabase[msg.sender][ID].release_approval == false);
